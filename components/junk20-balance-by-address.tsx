...
export function Junk20BalanceByAddress() {
  ...
  return (
    <Card className="bg-[#031126] border-[#ff5e01]/20 w-full overflow-hidden mt-8">
      ...
      <CardContent>
        <div className="mb-4 flex items-center space-x-2">
          ...
          />
          <Button onClick={fetchBalances} className="text-[#ff5e01] hover:text-[#ff5e01]/80" disabled={loading}>
        ...
        {balances.length > 0 ? (
            ...
            <Table className="w-full min-w-[640px]">
              <TableHeader>
                <TableRow className="hover:bg-[#031126]/80">
                  <TableHead className="text-[hsl(var(--body-text))]">Tick</TableHead>
              ...
              <TableBody>
                {balances.map((balance) => (
                  <TableRow key={balance.tick} className="hover:bg-[#031126]/80">
                    ...
                    <TableCell className="text-[hsl(var(--body-text))]">{formatNumber(balance.transferable)}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <p className="text-[hsl(var(--body-text))]">
            No balances to display. Enter an address and click the refresh button.
          </p>
        )}
      </CardContent>
    </Card>
